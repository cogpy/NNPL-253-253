...
. . . . On exactly such spots, undisturbed by the flow of vehicles, rose the fountains and monuments of old communities. . . . Connect the different "somethings" to one another with the path system - PATHS AND GOALS (120). They may include HIGH PLACES (62), DANCING IN THE STREETS (63), POOLS AND STREAMS (64), PUBLIC OUTDOOR ROOM (69), STILL WATER (71), TREE PLACES (171); make sure that each one has a SITTING WALL (243) around it. . . .
