...
## Patterns
apl241, apl242, apl243, apl244, apl245, apl246, apl247, apl248

## Emergent Phenomena
Exterior details that connect the building to its immediate surroundings
...
#### Pattern Agents
- `@apl0/dim2/cat3/seq35/apl001` through `@apl0/dim2/cat3/seq35/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim2/cat3/seq35/broader` - Broader context patterns
- `@apl0/dim2/cat3/seq35/narrower` - Narrower detail patterns
