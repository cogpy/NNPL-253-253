...
## Patterns
apl183, apl184, apl185, apl186, apl187, apl188, apl189

## Emergent Phenomena
Gardens that extend the life of the building and provide connection to nature
...
#### Pattern Agents
- `@apl0/dim2/cat2/seq25/apl001` through `@apl0/dim2/cat2/seq25/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim2/cat2/seq25/broader` - Broader context patterns
- `@apl0/dim2/cat2/seq25/narrower` - Narrower detail patterns
