...
## Patterns
apl095, apl096, apl097, apl098, apl099, apl100, apl101, apl102, apl103

## Emergent Phenomena
Building groups that create coherent outdoor spaces and support community interaction
...
#### Pattern Agents
- `@apl0/dim2/cat2/seq16/apl001` through `@apl0/dim2/cat2/seq16/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim2/cat2/seq16/broader` - Broader context patterns
- `@apl0/dim2/cat2/seq16/narrower` - Narrower detail patterns
