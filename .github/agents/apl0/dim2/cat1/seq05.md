...
## Patterns
apl016, apl017, apl018, apl019, apl020

## Emergent Phenomena
Connected networks that allow easy movement and communication while maintaining local character

## Overview
This sequence contains 5 pattern(s) that work together to create the emergent phenomena described above.
...
#### Pattern Agents
- `@apl0/dim2/cat1/seq05/apl001` through `@apl0/dim2/cat1/seq05/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim2/cat1/seq05/broader` - Broader context patterns
- `@apl0/dim2/cat1/seq05/narrower` - Narrower detail patterns
