...
#### Pattern Agents
- `@apl0/dim2/cat1/seq13/apl001` through `@apl0/dim2/cat1/seq13/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim2/cat1/seq13/broader` - Broader context patterns
- `@apl0/dim2/cat1/seq13/narrower` - Narrower detail patterns
