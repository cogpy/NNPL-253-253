...
## Patterns
apl172, apl173, apl174, apl175, apl176, apl177, apl178, apl179, apl180, apl181, apl182

## Emergent Phenomena
Buildings that open to and engage with their surroundings rather than turning inward
...
#### Pattern Agents
- `@apl0/dim4/cat2/seq24/apl001` through `@apl0/dim4/cat2/seq24/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim4/cat2/seq24/broader` - Broader context patterns
- `@apl0/dim4/cat2/seq24/narrower` - Narrower detail patterns
