...
## Patterns
apl120, apl121, apl122, apl123, apl124, apl125, apl126, apl127, apl128, apl129, apl130, apl131

## Emergent Phenomena
Pedestrian circulation that creates opportunities for encounter and makes spaces feel alive

## Overview
This sequence contains 12 pattern(s) that work together to create the emergent phenomena described above.
...
#### Pattern Agents
- `@apl0/dim4/cat2/seq19/apl001` through `@apl0/dim4/cat2/seq19/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim4/cat2/seq19/broader` - Broader context patterns
- `@apl0/dim4/cat2/seq19/narrower` - Narrower detail patterns
