...
#### Pattern Agents
- `@apl0/dim4/cat3/seq36/apl001` through `@apl0/dim4/cat3/seq36/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim4/cat3/seq36/broader` - Broader context patterns
- `@apl0/dim4/cat3/seq36/narrower` - Narrower detail patterns
