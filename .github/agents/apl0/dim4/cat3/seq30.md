...
## Patterns
apl209, apl210, apl211, apl212, apl213

## Emergent Phenomena
Coherent structural layouts that efficiently support the intended spatial arrangements
...
#### Pattern Agents
- `@apl0/dim4/cat3/seq30/apl001` through `@apl0/dim4/cat3/seq30/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim4/cat3/seq30/broader` - Broader context patterns
- `@apl0/dim4/cat3/seq30/narrower` - Narrower detail patterns
