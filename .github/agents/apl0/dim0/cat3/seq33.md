...
#### Pattern Agents
- `@apl0/dim0/cat3/seq33/apl001` through `@apl0/dim0/cat3/seq33/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim0/cat3/seq33/broader` - Broader context patterns
- `@apl0/dim0/cat3/seq33/narrower` - Narrower detail patterns
