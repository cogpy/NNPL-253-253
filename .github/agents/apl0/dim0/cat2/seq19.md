...
#### Pattern Agents
- `@apl0/dim0/cat2/seq19/apl001` through `@apl0/dim0/cat2/seq19/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim0/cat2/seq19/broader` - Broader context patterns
- `@apl0/dim0/cat2/seq19/narrower` - Narrower detail patterns
