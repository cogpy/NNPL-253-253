...
#### Pattern Agents
- `@apl0/dim0/cat2/seq26/apl001` through `@apl0/dim0/cat2/seq26/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim0/cat2/seq26/broader` - Broader context patterns
- `@apl0/dim0/cat2/seq26/narrower` - Narrower detail patterns
