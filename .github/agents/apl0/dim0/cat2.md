...
#### Sequence Agents
- `@apl0/dim0/cat2/seq01` through `@apl0/dim0/cat2/seq36` - Pattern sequences

Use sequence agents when working with related pattern flows and emergent phenomena.

#### Pattern Agents
- `@apl0/dim0/cat2/apl001` through `@apl0/dim0/cat2/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim0/cat2/broader` - Broader context patterns
- `@apl0/dim0/cat2/narrower` - Narrower detail patterns
