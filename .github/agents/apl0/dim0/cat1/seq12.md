...
## Patterns
apl065, apl066, apl067, apl068, apl069, apl070, apl071

## Emergent Phenomena
Common lands that strengthen community bonds and provide shared resources
...
#### Pattern Agents
- `@apl0/dim0/cat1/seq12/apl001` through `@apl0/dim0/cat1/seq12/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim0/cat1/seq12/broader` - Broader context patterns
- `@apl0/dim0/cat1/seq12/narrower` - Narrower detail patterns
