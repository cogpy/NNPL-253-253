...
## Patterns
apl190, apl191, apl192, apl193, apl194, apl195, apl196
...
#### Pattern Agents
- `@apl0/dim3/cat2/seq27/apl001` through `@apl0/dim3/cat2/seq27/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim3/cat2/seq27/broader` - Broader context patterns
- `@apl0/dim3/cat2/seq27/narrower` - Narrower detail patterns
