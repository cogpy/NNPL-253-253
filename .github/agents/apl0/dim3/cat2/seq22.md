...
#### Pattern Agents
- `@apl0/dim3/cat2/seq22/apl001` through `@apl0/dim3/cat2/seq22/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim3/cat2/seq22/broader` - Broader context patterns
- `@apl0/dim3/cat2/seq22/narrower` - Narrower detail patterns
