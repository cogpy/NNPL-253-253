...
#### Pattern Agents
- `@apl0/dim3/cat2/seq23/apl001` through `@apl0/dim3/cat2/seq23/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim3/cat2/seq23/broader` - Broader context patterns
- `@apl0/dim3/cat2/seq23/narrower` - Narrower detail patterns
