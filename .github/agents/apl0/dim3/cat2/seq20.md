...
## Patterns
apl132, apl133, apl134, apl135, apl136, apl137, apl138, apl139, apl140, apl141, apl142

## Emergent Phenomena
Spatial sequences that create privacy gradients and support different types of activities

## Overview
This sequence contains 11 pattern(s) that work together to create the emergent phenomena described above.
...
#### Pattern Agents
- `@apl0/dim3/cat2/seq20/apl001` through `@apl0/dim3/cat2/seq20/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim3/cat2/seq20/broader` - Broader context patterns
- `@apl0/dim3/cat2/seq20/narrower` - Narrower detail patterns
