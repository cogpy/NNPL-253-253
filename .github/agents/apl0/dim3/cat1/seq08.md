...
## Patterns
apl035, apl036, apl037, apl038, apl039, apl040

## Emergent Phenomena
Diverse housing that accommodates different household types and life stages

## Overview
This sequence contains 6 pattern(s) that work together to create the emergent phenomena described above.
...
#### Pattern Agents
- `@apl0/dim3/cat1/seq08/apl001` through `@apl0/dim3/cat1/seq08/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim3/cat1/seq08/broader` - Broader context patterns
- `@apl0/dim3/cat1/seq08/narrower` - Narrower detail patterns
