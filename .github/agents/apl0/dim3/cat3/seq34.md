...
## Patterns
apl233, apl234, apl235, apl236, apl237, apl238, apl239, apl240

## Emergent Phenomena
Interior surfaces and details that create comfortable and beautiful interior spaces

## Overview
This sequence contains 8 pattern(s) that work together to create the emergent phenomena described above.
...
#### Pattern Agents
- `@apl0/dim3/cat3/seq34/apl001` through `@apl0/dim3/cat3/seq34/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim3/cat3/seq34/broader` - Broader context patterns
- `@apl0/dim3/cat3/seq34/narrower` - Narrower detail patterns
