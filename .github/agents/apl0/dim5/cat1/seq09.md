...
## Patterns
apl041, apl042, apl043, apl044, apl045, apl046, apl047, apl048, apl049, apl050

## Emergent Phenomena
Integration of work into the fabric of community life rather than segregated industrial zones

## Overview
This sequence contains 10 pattern(s) that work together to create the emergent phenomena described above.
...
#### Pattern Agents
- `@apl0/dim5/cat1/seq09/apl001` through `@apl0/dim5/cat1/seq09/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim5/cat1/seq09/broader` - Broader context patterns
- `@apl0/dim5/cat1/seq09/narrower` - Narrower detail patterns
