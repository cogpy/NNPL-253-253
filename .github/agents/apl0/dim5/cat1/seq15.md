...
## Patterns
apl090, apl091, apl092, apl093, apl094

## Emergent Phenomena
Local economies that provide for daily needs and social gathering within walking distance
...
#### Pattern Agents
- `@apl0/dim5/cat1/seq15/apl001` through `@apl0/dim5/cat1/seq15/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim5/cat1/seq15/broader` - Broader context patterns
- `@apl0/dim5/cat1/seq15/narrower` - Narrower detail patterns
