...
#### Pattern Agents
- `@apl0/dim5/cat2/seq24/apl001` through `@apl0/dim5/cat2/seq24/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim5/cat2/seq24/broader` - Broader context patterns
- `@apl0/dim5/cat2/seq24/narrower` - Narrower detail patterns
