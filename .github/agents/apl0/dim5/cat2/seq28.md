...
## Patterns
apl197, apl198, apl199, apl200, apl201, apl202, apl203, apl204

## Emergent Phenomena
Walls with depth that provide storage, seating, and architectural richness
...
#### Pattern Agents
- `@apl0/dim5/cat2/seq28/apl001` through `@apl0/dim5/cat2/seq28/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim5/cat2/seq28/broader` - Broader context patterns
- `@apl0/dim5/cat2/seq28/narrower` - Narrower detail patterns
