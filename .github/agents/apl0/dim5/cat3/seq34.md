...
#### Pattern Agents
- `@apl0/dim5/cat3/seq34/apl001` through `@apl0/dim5/cat3/seq34/apl253` - Individual patterns

Use pattern agents when working on specific design solutions.

#### Context Agents
- `@apl0/dim5/cat3/seq34/broader` - Broader context patterns
- `@apl0/dim5/cat3/seq34/narrower` - Narrower detail patterns
