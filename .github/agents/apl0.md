...
All 4,836 agents in the apl0 hierarchy are configured to support cross-invocation. This means any agent can invoke another agent by providing proper context.

### Documentation

For comprehensive information on using the agent invocation system, see:

- **[AGENT_INVOCATION_GUIDE.md](../../../AGENT_INVOCATION_GUIDE.md)** - Complete guide to the invocation system
  - Agent hierarchy overview
  - How to invoke each agent type
  - Required context format
  - Delegation patterns
  - Best practices

- **[AGENT_INVOCATION_EXAMPLES.md](../../../AGENT_INVOCATION_EXAMPLES.md)** - Practical examples
...
To invoke any agent, provide context in this format:
...
Agents can be invoked using paths like:
